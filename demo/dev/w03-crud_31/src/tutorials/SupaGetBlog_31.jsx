...
let api_url = 'https://szbwskgtksqzkhaokhez.supabase.co/rest/v1/card_31?select=*';

const SupaClientGetBlog_31 = () => {
  ...
  const fetchBlogsFromSupabase = async () => {
    try {
     ...
     //let { data, error } = await supabase.from('card_59').select('*');
...
export default SupaClientGetBlog_31;